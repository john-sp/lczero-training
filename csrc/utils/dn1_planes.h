...
constexpr int kDn1ControlPlusPlane = 94;
...
constexpr int kDn1OurDiscoveredChecksPlane = 100;

constexpr int kDn1OurPassedPawnsPlane = 101;
constexpr int kDn1TheirPassedPawnsPlane = 102;
